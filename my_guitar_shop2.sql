...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2014 at 12:49 AM
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `onHand` int(4) NOT NULL,
  `pendingOrders` int(4) NOT NULL,
...
INSERT INTO `products` (`productID`, `categoryID`, `productCode`, `productName`, `description`, `listPrice`, `discountPercent`, `dateAdded`, `onHand`, `pendingOrders`) VALUES
